...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CryptoGaule Core cryptogaule-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cryptogaule-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptogaule transaction") + "\n" +
              "  cryptogaule-tx [options] -create [commands]   " + _("Create hex-encoded cryptogaule transaction") + "\n" +
              "\n";
